...
const SettingsView: React.FC<SettingsViewProps> = ({ backendUrl }) => {
  return (
    <div className="flex-1 overflow-y-auto bg-[#0b1220] p-8 animate-in fade-in duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-900 rounded-xl border border-slate-800 p-6 shadow-xl">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-slate-800/60 rounded-lg border border-slate-700/70">
                <span className="text-slate-400 font-mono text-sm">Core Service</span>
                <div className="flex items-center gap-2">
                   <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></div>
                   <span className="text-emerald-300 text-xs font-bold bg-emerald-500/10 px-2 py-1 rounded">ONLINE</span>
                </div>
              </div>
              <div className="flex justify-between items-center p-3 bg-slate-800/60 rounded-lg border border-slate-700/70">
                <span className="text-slate-400 font-mono text-sm">Gemini Model</span>
                <span className="text-indigo-300 text-xs font-bold bg-indigo-500/10 px-2 py-1 rounded">GEMINI-3-FLASH</span>
              </div>
               <div className="flex justify-between items-center p-3 bg-slate-800/60 rounded-lg border border-slate-700/70">
          ...
          <div className="bg-slate-900 rounded-xl border border-slate-800 p-6 shadow-xl">
            ...
            <div className="space-y-4">
               <div className="flex items-center justify-between">
                  <div>
                    <div className="text-slate-100 font-medium">Video Analysis</div>
                    <div className="text-slate-500 text-xs">Real-time object detection</div>
                  </div>
                  <ToggleRight className="text-indigo-400 cursor-pointer hover:text-indigo-300 transition-colors" size={32} />
               </div>
               <div className="flex items-center justify-between">
                  <div>
                    <div className="text-slate-100 font-medium">Social Sentinel</div>
               ...
               <div className="flex items-center justify-between">
                  <div>
                    <div className="text-slate-100 font-medium">Acoustic Arrays</div>
                    <div className="text-slate-500 text-xs">Decibel anomaly detection</div>
                  </div>
                   <ToggleLeft className="text-slate-500 cursor-pointer hover:text-slate-400 transition-colors" size={32} />
               </div>
            </div>
          </div>
           ...
           <div className="bg-slate-900 rounded-xl border border-slate-800 p-6 shadow-xl md:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
               <div className="p-4 bg-slate-950 rounded border border-slate-800 flex flex-col items-center text-center gap-2">
                  ...
                  <div className="text-slate-100 font-mono">ADMINISTRATOR</div>
               </div>
                <div className="p-4 bg-slate-950 rounded border border-slate-800 flex flex-col items-center text-center gap-2">
                  <div className="text-slate-400 text-xs uppercase font-bold">Region</div>
                  <div className="text-slate-100 font-mono">LOS ANGELES (DOWNTOWN)</div>
               </div>
                <div className="p-4 bg-slate-950 rounded border border-slate-800 flex flex-col items-center text-center gap-2">
                  <div className="text-slate-400 text-xs uppercase font-bold">Auth Token</div>
                  <div className="text-emerald-300 text-xs font-mono">ACTIVE (Expires 2h)</div>
               </div>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-4">
               <div className="flex flex-col gap-1">
                 ...
                 <div className="flex gap-2">
                    <input type="text" value={backendUrl} readOnly className="flex-1 bg-slate-950 border border-slate-700 rounded px-3 py-2 text-slate-200 font-mono text-sm focus:outline-none focus:border-indigo-400 transition-colors" />
